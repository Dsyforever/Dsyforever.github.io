...
- Analyze the loss landscapes properties (Smoothness, Hessian, River-Valley,etc.) of large-scale neural networks and the behavior of optimization algorithms under specific loss landscapes, and develop scalable optimization algorithms based on the optimization properties of the loss landscapes.
